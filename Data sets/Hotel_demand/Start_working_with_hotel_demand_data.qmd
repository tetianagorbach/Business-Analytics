...
To load the data in R environment, download the data from Canvas to your computer and use the command `readRDS` as below. Do not forget to substitute the path to the file to the path to the file on YOUR computer
