...
and THE SAME FOLDER AS THIS QUARTO file and use the command `readRDS` as below. Otherwise, you have to specify the full path to the data file in the `readRDS` command.
